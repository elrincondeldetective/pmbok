...
interface AddVersionModalProps {
    isVisible: boolean;
    onClose: () => void;
    // ===== CAMBIO 1: onConfirm ahora acepta el nombre y la URL =====
...
const AddVersionModal: React.FC<AddVersionModalProps> = ({ isVisible, onClose, onConfirm, parentName }) => {
    ...
    // ===== CAMBIO 2: Añadir estado para la URL =====
    ...
    useEffect(() => {
        if (isVisible) {
            ...
            // Limpiar la URL cada vez que el modal se abre
            setUrl('');
        }
    ...
    const handleConfirm = () => {
        if (name.trim()) {
            // ===== CAMBIO 3: Pasar el nombre y la URL al confirmar =====
                ...
                <div className="p-6">
                    <div className="text-center">
                        ...
                        <p className="mb-5 text-sm text-gray-600">
                            Ingresa un nombre descriptivo y opcionalmente una URL.
                        </p>
                        <div className="space-y-4">
                            <input
                                ...
                                autoFocus
                            />
                            {/* ===== CAMBIO 4: Añadir el campo de entrada para la URL ===== */}
                            <input
                                type="text"
                                value={url}
                                ...
                                onKeyDown={handleKeyDown}
                                className="w-full p-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                                placeholder="URL de Google Docs (opcional)..."
                            />
                        </div>
                    </div>
